...
$('paceToggle').textContent='×'+state.speed;$('gameSpeed').value=state.speed;$('gameHint').textContent='Toca tu tienda · v0.12 · ritmo ×'+state.speed;$('used').textContent=used();$('capacity').textContent=state.capacity;
