...
if(kind==='plants')return box(0,-30,100,70,30)+plant(0,-30,.8)+plant(40,-10,.7)+plant(0,0,.65);
 ...
 if(kind==='warehouse')return hit('warehouse','Recepción y almacén','<path d="M0 0L55 27.5L0 55L-55 27.5Z" fill="#b9c9aa" opacity=".65"/><g class="receipt-load"></g>'+box(0,-32,39,33,32)+'<g class="warehouse-extra" style="display:none">'+box(0,-61,34,29,29)+'</g>'+(typeof state!=='undefined'&&state.warehouse2?box(0,-87,29,25,26):''));
 return hit('counter','Mostrador y actividad',box(0,-58,157,66,58,'#e7c594','#bf9363','#ab8156')+'<g transform="translate(40 -47)"><path d="M0 0L26 13L13 20L-13 7Z" fill="#517568"/><path d="M-3 4V-17L19-6V15Z" fill="#375c54"/><path d="M0-12L15-5V5L0-2Z" fill="#b9ddbd"/></g><g class="counter-products" transform="translate(95 -23)"><rect x="0" y="0" width="12" height="19" rx="3" fill="#deb780"/><rect x="3" y="-3" width="6" height="5" rx="1" fill="#7a9578"/><rect x="19" y="9" width="10" height="18" rx="3" fill="#89b5a3"/><rect x="21" y="6" width="6" height="5" rx="1" fill="#517f73"/></g>');
}
