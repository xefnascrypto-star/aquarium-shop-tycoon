...
if(kind==='plants')return box(0,-30,100,70,30)+plant(0,-30,.8)+plant(40,-10,.7)+plant(0,0,.65);
 ...
 return hit('counter','Mostrador y actividad','<g class="shop-clerk" transform="translate(55 -42)">'+person(ShopIdentity.colors[ShopIdentity.current.color])+'<path d="M-9-37H9V-16H-9Z" fill="#f4e2bb"/><svg class="brand-badge" x="-7" y="-35" width="14" height="14" viewBox="0 0 64 64">'+ShopIdentity.mark().replace(/^<svg[^>]*>|<\/svg>$/g,'')+'</svg></g>'+(typeof state!=='undefined'&&state.employee?'<g class="second-employee shop-clerk" transform="translate(110 -13)">'+person(ShopIdentity.colors[ShopIdentity.current.color])+'</g>':'')+box(0,-58,157,66,58,'#e7c594','#bf9363','#ab8156')+'<g transform="translate(40 -47)"><path d="M0 0L26 13L13 20L-13 7Z" fill="#517568"/><path d="M-3 4V-17L19-6V15Z" fill="#375c54"/><path d="M0-12L15-5V5L0-2Z" fill="#b9ddbd"/></g><g class="counter-products" transform="translate(95 -23)"><rect x="0" y="0" width="12" height="19" rx="3" fill="#deb780"/><rect x="3" y="-3" width="6" height="5" rx="1" fill="#7a9578"/><rect x="19" y="9" width="10" height="18" rx="3" fill="#89b5a3"/><rect x="21" y="6" width="6" height="5" rx="1" fill="#517f73"/></g>');
}
